...
from aura.dsc.cogs.admin import _is_admin
    ...
    "admin": HelpTopic(
        ...
        fields=(
            ...
            (
                ...
                "• `/etc/aura/aura.yaml` — **all Discord IDs live here** (guild, "
                "#intel-alerts / #intel-live / #bot-health channel ids, @Pilot and FC "
                "role ids, watched voice channels) plus thresholds\n"
                "• `/etc/aura/routing.yaml` — which role is mentioned for which "
                "incident types where; quiet hours per role\n"
                "• `/etc/aura/gazetteer.yaml` — region allowlist / jump radius "
            ...
            (
                ...
                "2. Put every ID in `aura.yaml` (`discord:` section)\n"
