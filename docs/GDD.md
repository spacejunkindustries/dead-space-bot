...
| "what can you do" / "what do you do" / "what are your commands" / "list your commands" / "capabilities" | `CAPABILITIES` | none | speaks a fixed capabilities overview (voice-only, like FACT/INSULT); slash twin `/capabilities` sends the same text mention-free |
